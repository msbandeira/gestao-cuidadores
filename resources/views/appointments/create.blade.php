                    ...
                    <form method="POST" action="{{ route('appointments.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="client_id" name="client_id" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" required>
                                ...
                                @foreach ($clients as $client)
                                    <option value="{{ $client->id }}" {{ old('client_id') == $client->id ? 'selected' : '' }}>{{ $client->cpf }} - {{ $client->full_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="professional_id" name="professional_id" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" required>
                                ...
                                @foreach ($professionals as $professional)
                                    <option value="{{ $professional->id }}" {{ old('professional_id') == $professional->id ? 'selected' : '' }}>{{ $professional->full_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="service_plan_id" name="service_plan_id" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" required>
                                ...
                                @foreach ($servicePlans as $plan)
                                    <option value="{{ $plan->id }}" data-price="{{ $plan->price }}" data-repass="{{ $plan->professional_repass_value }}" data-intake="{{ $plan->company_intake_value }}" {{ old('service_plan_id') == $plan->id ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="duration_minutes" class="block mt-1 w-full" type="number" name="duration_minutes" :value="old('duration_minutes')" placeholder="Ex: 60" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="price_charged" class="block mt-1 w-full" type="number" step="0.01" name="price_charged" :value="old('price_charged')" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="professional_repass" class="block mt-1 w-full" type="number" step="0.01" name="professional_repass" :value="old('professional_repass')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="company_intake" class="block mt-1 w-full" type="number" step="0.01" name="company_intake" :value="old('company_intake')" />
